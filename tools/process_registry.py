...
class ProcessRegistry:
    ...
    def __init__(self):
        ...
        # Sensitive profiles set HERMES_NO_DURABLE_STATE: importing the restore
        # path would otherwise create an empty state.db even when no persistence
        # tools are enabled and no conversation is saved.
        if os.environ.get("HERMES_NO_DURABLE_STATE") != "1":
            try:
